...
export default function AdminSolicitacoes() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="font-display font-bold text-2xl lg:text-3xl text-white uppercase tracking-wider">Solicitações do Site</h1>
        <p className="text-gray-500 font-body text-sm mt-1">{orcamentos.length} solicitações recebidas pelo formulário público</p>
      </div>
        ...
        <div className="card-dark overflow-hidden">
          {loading ? (
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-gray-500 font-body text-sm">Nenhuma solicitação encontrada.</p>
            </div>
          ) : (
